...
- (void)setNavItem{
    ...
    [rightButton addTarget:self action:@selector(saveCupInfo) forControlEvents:UIControlEventTouchUpInside];
...
- (UITableView *)cupAddTable{
    if (!_cupAddTable) {
        _cupAddTable = ({
            TouchTableView *tableView = [[TouchTableView alloc] initWithFrame:CGRectMake(0, 44/HScale, ScreenWidth, ScreenHeight - 64 - 74/HScale) style:UITableViewStylePlain];
          ...
          success:^(NSURLSessionDataTask * _Nonnull task, id  _Nullable responseObject) {
              ...
              if ([[responseObject objectForKey:@"errno"] intValue] == 0) {
                  ...
                  if ([responseObject objectForKey:@"data"]) {
                      NSDictionary *beansDic = [responseObject objectForKey:@"data"];
