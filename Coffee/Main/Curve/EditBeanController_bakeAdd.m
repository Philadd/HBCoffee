...
NSString *const CellIdentifier_EditbBean_bakeadd = @"CellID_EditBean_bakeadd";


@interface EditBeanController_bakeAdd () <UITableViewDelegate,UITableViewDataSource>
...
@implementation EditBeanController_bakeAdd
{
    BOOL isConnect;
    int resendTime;
}
...
- (UITableView *)beanTable{
    if (!_beanTable) {
        _beanTable = ({
            ...
            [tableView registerClass:[beanCell class] forCellReuseIdentifier:CellIdentifier_EditbBean_bakeadd];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    beanCell *cell = [tableView dequeueReusableCellWithIdentifier:CellIdentifier_EditbBean_bakeadd];
    if (cell == nil) {
        cell = [[beanCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:CellIdentifier_EditbBean_bakeadd];
    }
    if (_sort_generalBtn.tag == sortSelect) {//综合排序
        ...
        cell.beanImage.image = [UIImage imageNamed:@"img_coffee_beans"];
        cell.beanLabel.text = LocalString(@"样品豆");
