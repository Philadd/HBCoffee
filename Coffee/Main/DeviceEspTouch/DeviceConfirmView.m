...
- (instancetype)init
{
    self = [super init];
    if (self) {
        deviceTypeNameArray = @[LocalString(@"HB-M6G咖啡烘焙机"),LocalString(@"HB-L2咖啡烘焙机"),LocalString(@"PEAK-Edmund咖啡烘焙机"),LocalString(@"HB-M6E咖啡烘焙机"),LocalString(@"其他机型")];
    }
    return self;
}
...
//    self.navigationItem.rightBarButtonItem = rightBar;
    ...
    [rightButton addTarget:self action:@selector(goApView) forControlEvents:UIControlEventTouchUpInside];
