...
- (void)viewWillAppear:(BOOL)animated{
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(clickBakeOver) name:@"bakeCompelete" object:nil];
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(drawRightViewContent) name:@"isStartBake" object:nil];
}

- (void)viewWillDisappear:(BOOL)animated{
    [super viewWillDisappear:animated];
    [[NSNotificationCenter defaultCenter] removeObserver:self name:@"isStartBake" object:nil];
...
- (void)drawRightViewContent{
    ...
    curveLabel.frame = CGRectMake(472.5/WScaleT,327.5/HScaleT,100/WScaleT,21/HScaleT);
    curveLabel.text = LocalString(@"参考曲线");
    curveLabel.font = [UIFont fontWithName:@"PingFangSC-Regular" size:15];
    curveLabel.adjustsFontSizeToFitWidth = YES;
