...
- (LineChartView *)chartView{
    if (!_chartView) {
        ...
        [bottomLabel mas_makeConstraints:^(MASConstraintMaker *make) {
            ...
            make.left.equalTo(self.chartView.mas_right).offset(-15/HScale);
        ...
        xAxis.granularity = 60; //精度按一分钟 60s
        ...
        leftAxis.axisMaximum = [NSString diffTempUnitStringWithTemp:[DataBase shareDataBase].setting.tempAxis];
        leftAxisMax = [NSString diffTempUnitStringWithTemp:[DataBase shareDataBase].setting.tempAxis];
...
- (void)uiMasonry{
    ...
    [_developTime mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.left.mas_equalTo(self.bakeTime.mas_right).offset(39/HScale);
    }];
    ...
    [_developRate mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.left.mas_equalTo(self.developTime.mas_right).offset(37/HScale);
    }];
    ...
    [_beanTempLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.left.mas_equalTo(self.developRate.mas_right).offset(47/HScale);
    }];
    ...
    [_inTempLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.left.mas_equalTo(self.beanTempLabel.mas_right).offset(24/HScale);
    }];
    ...
    [_outTempLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.left.mas_equalTo(self.inTempLabel.mas_right).offset(32/HScale);
    }];
    ...
    [_environTempLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.left.mas_equalTo(self.outTempLabel.mas_right).offset(26/HScale);
    }];
    ...
    [_beanTempRateLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.left.mas_equalTo(self.environTempLabel.mas_right).offset(26/HScale);
    }];
...
- (void)popRightControlView{
    ...
    rfVC.relaSwitch = ^(BOOL isOn) {
        LineChartDataSet *rela1 = (LineChartDataSet *)self.chartView.data.dataSets[5];//热风温
        LineChartDataSet *rela2 = (LineChartDataSet *)self.chartView.data.dataSets[6];//排气温
        LineChartDataSet *rela3 = (LineChartDataSet *)self.chartView.data.dataSets[7];//豆温
        LineChartDataSet *rela4 = (LineChartDataSet *)self.chartView.data.dataSets[8];//环境温
        LineChartDataSet *rela5 = (LineChartDataSet *)self.chartView.data.dataSets[9];//升温率
        isRelaOn = isOn;
        if (isOn) {
            //目前需求只是两条参考曲线
            //rela1.visible = YES;
...
- (void)setRelaCurve{
    ...
    if (net.relaCurve.curveValueJson) {
        ...
        for (long i = beanRorDiffCount; i < Bean.count; i = i + beanRorDiffCount) {
...
//    }
    ...
    else
    {
        ...
        rela1.axisDependency = AxisDependencyLeft;
        ...
        rela2.axisDependency = AxisDependencyLeft;
        ...
        rela3.axisDependency = AxisDependencyLeft;
        ...
        rela4.axisDependency = AxisDependencyLeft;
