...
- (void)drawLeftViewContent{
    ...
    label1.frame = CGRectMake(0/WScaleT,76.5/HScaleT,80/WScaleT,18.5/HScaleT);
    label1.text = LocalString(@"电源");
    ...
    label2.frame = CGRectMake(80/WScaleT,76.5/HScaleT,80/WScaleT,18.5/HScaleT);
    label2.text = LocalString(@"点火");
    ...
    label3.frame = CGRectMake(0/WScaleT,201.5/HScaleT,80/WScaleT,18.5/HScaleT);
    label3.text = LocalString(@"搅拌");
    ...
    label4.frame = CGRectMake(80/WScaleT,201.5/HScaleT,80/WScaleT,18.5/HScaleT);
    label4.text = LocalString(@"冷却");
    ...
    label5.frame = CGRectMake(0/WScaleT,326.5/HScaleT,80/WScaleT,18.5/HScaleT);
    label5.text = LocalString(@"火力");
    ...
    label6.frame = CGRectMake(80/WScaleT,326.5/HScaleT,80/WScaleT,18.5/HScaleT);
    label6.text = LocalString(@"风力");
