...
@interface HBForgetPasswordController () <UITableViewDelegate, UITableViewDataSource>
...
@implementation HBForgetPasswordController
...
- (void)registerUser{
    ...
    [manager PUT:@"http://139.196.90.97:8080/coffee/user/password/code" parameters:parameters headers:nil
          success:^(NSURLSessionDataTask * _Nonnull task, id  _Nullable responseObject) {
